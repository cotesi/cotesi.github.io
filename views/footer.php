    <footer class="footer">
        ...
        <div class="bottom-bar">
            <div class="container">
                <span class="copyright text-center w-100"> © <?= date('Y') ?> COTESI (Congresso de Tecnologia e Sistemas de Informação)
    ...
    <script src="public/js/locomotive-scroll.min.js"></script>
